<?php 
	...
	if (isset($_POST['btnCreate'])) {
		...
		$sql = "INSERT INTO users(name, username, password, gender, address, class_id, role, created_at) VALUES ('$fullname', '$username', '$password', '$gender', '$address', $class, '$role', '$time')";
		...
		if ($totalRecord <= ($limit * $page)) {
			...
			$url =  "readDataAdmin.php?page=" . ($page + 1);
		}
...
<!-- 					<div class="radio">
						<p><b>Role</b></p>
						<label>
							<input type="radio" name="role" id="input" value="1" checked="checked">
							Admin
						</label>
						<label>
							<input type="radio" name="role" id="input" value="0">
							Member
						</label>
					</div> -->
					<div class="form-group">

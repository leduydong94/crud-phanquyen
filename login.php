<?php 
	...
	if (isset($_SESSION['loginSuccess']) && $_SESSION['loginSuccess'] == 1 && $_SESSION['role'] == 1) {
		header("Location: readDataAdmin.php");
	} else if (isset($_SESSION['loginSuccess']) && $_SESSION['loginSuccess'] == 1 && $_SESSION['role'] != 1) {
		header("Location: readDataMember.php");
	}
 ?>
